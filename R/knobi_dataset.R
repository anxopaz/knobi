...
#' # hake_n<-icesSAG::getSAG(stock="hke.27.3a46-8abd",year=2021); hake_n<-hake_n[-nrow(hake_n),]  
#'   
...
#'
#' The 'AMO' data, i.e. The Atlantic Multi-decadal Oscillation index; and the 'NAO' data, i.e. the North Atlantic Oscillation index, which are both large-scale climate variability patterns that affects the entire North Atlantic Ocean, were downloaded from the UCAR website (https://climatedataguide.ucar.edu/).
#'
...
#'
#' @source `getSAG` function of the "icesSAG" package and the UCAR website (https://climatedataguide.ucar.edu/).
#'
"knobi_dataset"
