...
#' The 'AMO' data, i.e. The Atlantic Multi-decadal Oscillation (AMO) is a large-scale climate variability pattern that affects the entire North Atlantic Ocean, was also downloaded by hand from the UCAR website (https://climatedataguide.ucar.edu/).
#'
